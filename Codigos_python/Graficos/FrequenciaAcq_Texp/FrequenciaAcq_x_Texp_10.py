...
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS10MHz\X1024_B1_Propagado.xlsm') 
...
lengthTexp = len(FREQ1024B1)-1

# Faz a leitura da planilha e pega os valores das colunas
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS10MHz\X512_B1_Propagado.xlsm') 
columns = pd.DataFrame(df)
Freq    = {}
...
# Faz a leitura da planilha e pega os valores das colunas
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS10MHz\X256_B1_Propagado.xlsm') 
columns = pd.DataFrame(df)
Freq    = {}
...
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS10MHz\X1024_B2_Propagado.xlsm') 
columns = pd.DataFrame(df)

TEXP1024B2 = columns['TEXP (s)'][0:21]
FREQ1024B2 = columns['FREQ (fps)'][0:21]

# Faz a leitura da planilha e pega os valores das colunas
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS10MHz\X512_B2_Propagado.xlsm') 
columns = pd.DataFrame(df)
TEXP512B2 = columns['TEXP (s)'][0:31]
FREQ512B2 = columns['FREQ (fps)'][0:31]

# Faz a leitura da planilha e pega os valores das colunas
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS10MHz\X256_B2_Propagado.xlsm') 
columns = pd.DataFrame(df)
TEXP256B2 = columns['TEXP (s)'][0:31]
FREQ256B2 = columns['FREQ (fps)'][0:31]
