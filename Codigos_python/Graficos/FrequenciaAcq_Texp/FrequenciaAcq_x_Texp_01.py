...
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS01MHz\X1024_B1_Propagado.xlsm') 
columns = pd.DataFrame(df)

TEXP1024B1 = columns['TEXP (s)'][0:22]
FREQ1024B1 = columns['FREQ (fps)'][0:22]
ERRO1024B1 = columns['Error (fps)'][0:22]
lengthTexp = len(TEXP1024B1)-1

# Faz a leitura da planilha e pega os valores das colunas
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS01MHz\X512_B1_Propagado.xlsm') 
columns = pd.DataFrame(df)
TEXP512B1 = columns['TEXP (s)'][0:27]
FREQ512B1 = columns['FREQ (fps)'][0:27]
ERRO512B1 = columns['Erro (fps)'][0:27]

# Faz a leitura da planilha e pega os valores das colunas
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS01MHz\X256_B1_Propagado.xlsm') 
columns = pd.DataFrame(df)
Freq    = {}
TEXP256B1 = columns['TEXP (s)'][0:23]
FREQ256B1 = columns['FREQ (fps)'][0:23]
ERRO256B1 = columns['Erro (fps)'][0:23]
...
ax.errorbar(TEXP256B1, FREQ256B1, ERRO256B1, marker='o', c='green',linewidth=1.0, label=r'$\mathtt{x256, \; B1}$')
ax.errorbar(TEXP512B1, FREQ512B1, ERRO512B1, marker='o', c='red',linewidth=1.0, label=r'$\mathtt{x512, \; B1}$')
ax.errorbar(TEXP1024B1, FREQ1024B1, ERRO1024B1, marker='o', c='blue',linewidth=1.0, label=r'$\mathtt{x1024, \; B1}$')
...
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS01MHz\X1024_B2_Propagado.xlsm') 
columns = pd.DataFrame(df)
...
# Faz a leitura da planilha e pega os valores das colunas
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS01MHz\X512_B2_Propagado.xlsm') 
columns = pd.DataFrame(df)
TEXP512B2 = columns['TEXP (s)'][0:23]
FREQ512B2 = columns['FREQ (fps)'][0:23]

# Faz a leitura da planilha e pega os valores das colunas
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS01MHz\X256_B2_Propagado.xlsm') 
columns = pd.DataFrame(df)
...
ax.errorbar(TEXP256B2, FREQ256B2, marker='o', c='green',linewidth=1.0, label=r'$\mathtt{x256, \; B1}$')
ax.errorbar(TEXP512B2, FREQ512B2, marker='o', c='red',linewidth=1.0, label=r'$\mathtt{x512, \; B1}$')
ax.errorbar(TEXP1024B2, FREQ1024B2, marker='o', c='blue',linewidth=1.0, label=r'$\mathtt{x1024, \; B1}$')
