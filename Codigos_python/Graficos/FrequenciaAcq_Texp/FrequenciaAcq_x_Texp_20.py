...
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS20MHz\X1024_B1_Propagado.xlsm') 
...
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS20MHz\X512_B1_Propagado.xlsm') 
columns = pd.DataFrame(df)
Freq    = {}
...
# Faz a leitura da planilha e pega os valores das colunas
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS20MHz\X256_B1_Propagado.xlsm') 
columns = pd.DataFrame(df)
Freq    = {}
...
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS20MHz\X1024_B2_Propagado.xlsm') 
columns = pd.DataFrame(df)

TEXP1024B2 = columns['TEXP (s)'][0:25]
FREQ1024B2 = columns['FREQ (fps)'][0:25]

# Faz a leitura da planilha e pega os valores das colunas
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS20MHz\X512_B2_Propagado.xlsm') 
columns = pd.DataFrame(df)
TEXP512B2 = columns['TEXP (s)'][0:26]
FREQ512B2 = columns['FREQ (fps)'][0:26]

# Faz a leitura da planilha e pega os valores das colunas
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Acq_Frequency\HSS20MHz\X256_B2_Propagado.xlsm') 
columns = pd.DataFrame(df)
TEXP256B2 = columns['TEXP (s)'][0:33]
FREQ256B2 = columns['FREQ (fps)'][0:33]
