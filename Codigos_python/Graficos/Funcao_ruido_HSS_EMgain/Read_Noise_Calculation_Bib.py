...
class ReadNoiseCalc:
    ...
    def write_operation_mode(self, em_mode, em_gain, hss, preamp, binn):
        ...
        self.em_mode = em_mode[0]
        self.em_gain = em_mode[1]#em_gain
        self.hss = em_mode[2]#hss
        self.preamp = em_mode[3]#preamp
        self.binn = em_mode[4]#binn
    ...
    def calc_read_noise_em(self):
        ...
        tab_name = 'RN_PA' + str(int(self.preamp)) + 'B' + str(int(self.binn)) + 'HSS' + str(int(self.hss)) + '.xlsm'           
