...
df = pd.read_excel ('C:\Users\observer\Desktop\Ensaios_e_Caracterizacoes\Planilhas\Ganho_EM\HSS20MHz\Propagado.xlsm') 
...
ax.text(0.3, 0.3, string1, ha='left',va='center', transform=ax.transAxes, size=fontsize)
ax.text(0.3, 0.1, string2, ha='left',va='center', transform=ax.transAxes, size=fontsize)
